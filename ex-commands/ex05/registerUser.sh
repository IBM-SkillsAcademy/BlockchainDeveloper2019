...
fabric-ca-client register --id.type client --id.name $1 --id.affiliation org1.department1 --id.attrs 'role=Manufacturer:ecert' --id.attrs 'hf.Revoker=true,admin=true:ecert' --tls.certfiles ca.org1.example.com-cert.pem 
