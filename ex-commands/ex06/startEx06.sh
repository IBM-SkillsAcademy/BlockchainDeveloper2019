...
cp -f ex-commands/ex06/collections_config.json ../../SampleApplication/contract/collections_config.json
cp -f ex-commands/ex06/package.json ../../SampleApplication/contract/package.json
