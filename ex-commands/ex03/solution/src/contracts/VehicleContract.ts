...
// ############################################################### Order Functions #################################################
    ...
    public async placeOrder(ctx: VehicleContext, orderId: string, owner: string, make: string, model: string, color: string,
    ) {
    ...
    public async getOrdersByRange(ctx: VehicleContext, startKey: string, endKey: string) {
        // use object returned from getOrderList and call getOrdersByRange
    ...
    public async requestPolicy(ctx: VehicleContext, id: string, vehicleNumber: string, insurerId: string, holderId: string, policyType: PolicyType, startDate: number, endDate: number) {
